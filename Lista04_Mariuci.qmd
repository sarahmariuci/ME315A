...
18. Os seguintes exercícios utilizam a tabela EMPLOYEE.
Exiba todas as informações sobre qualquer funcionário que trabalhe em um departamento com um valor de DNO na seguinte lista: {10, 40}.
```{sql connection=con}
